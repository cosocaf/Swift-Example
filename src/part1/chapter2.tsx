...
export const Chapter2 = () => {
  ...
  return (
    <main>
      ...
      <p>今回は次のことを学びました。</p>
      <ul>
        <li>print()で文字を画面に表示できる</li>
        <li>print()を複数書くことで複数行表示できる</li>
        <li>文字列は&quot;で囲わなければならない</li>
        <li>数字は&quot;で囲ってはいけない</li>
        <li>+や-などで数字の計算ができる</li>
        <li>+で文字列同士を結合できる</li>
        {/* eslint-disable-next-line react/jsx-no-comment-textnodes */}
        <li>//や/* */でコメントを書くことができる</li>
        <li>コメントはプログラムの実行に影響を与えない</li>
        <li>letで変数を定義できる</li>
        <li>readLine()!でキーボードから入力を受け取ることができる</li>
      </ul>
